    ...
    return (
      <div
        ...
        style={{
          ...
          background: required ? "#fff" : uploaded ? "#fff" : "var(--color-line-2)",
          flexWrap: "wrap",
        }}
      >
        {/* Icon */}
        <div
          style={{
            ...
            height: 40,
            borderRadius: 10,
            background: uploaded ? "var(--color-green-bg)" : required ? "var(--color-blue-x)" : "#fff",
            display: "flex",
            alignItems: "center",
        ...
        {uploaded ? (
          ...
          <button
            ...
            style={{
              ...
              background: required ? "var(--color-blue-x)" : "#fff",
