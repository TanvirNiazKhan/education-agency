import { Avatar, avatarColors, getProgressColor } from "@/components/ui";
...
export function BoardView({ columns, onCardClick }: BoardViewProps) {
  return (
    <div className="flex-1 overflow-x-auto overflow-y-hidden px-4 pb-4 sm:px-8 sm:pb-6">
      <div className="flex h-full" style={{ gap: "14px", minWidth: "min-content" }}>
        {columns.map((col) => {
          ...
          const label = STATUS_LABELS[col.stage] || col.stage;
          return (
            <div
              key={col.stage}
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between">
                        <span className="flex items-center" style={{ gap: "4px", fontSize: "11px", color: c.docsUploaded > 0 ? "var(--c-text-4)" : "#d97706", fontWeight: 500 }}>
                          <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
                            <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" />
                          </svg>
                          {c.docsUploaded > 0 ? `${c.docsUploaded} docs` : "No docs"}
                        </span>
